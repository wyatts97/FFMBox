...
import type { PresetCategory, PresetOptions, BasePreset, CustomPreset, AnyPreset } from '@/types/presets';
import { isCustomPreset, isBasePreset } from '@/types/presets'; // Import type guards
...
const renderVideoOptions = (
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Add resolution options if they are present in the preset's default options */}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={createChangeHandler('width', (k, v) => handleChange(k, Number(v)))}
              className="w-full p-2 border rounded text-black dark:text-black"
              placeholder="Auto"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={createChangeHandler('height', (k, v) => handleChange(k, Number(v)))}
              className="w-full p-2 border rounded text-black dark:text-black"
              placeholder="Auto"
            />
          </div>
  ...
  },
  {
    ...
    getOptions: (fileType, options, onChange) => (
      <div>
        ...
        <input
          type="text"
          value={(options.start?.toString() ?? '00:00:00')}
