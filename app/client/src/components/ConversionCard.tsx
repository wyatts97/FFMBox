...
import { Play, Download, Trash2, Clock, FileVideo, FileAudio, FileImage, Edit, CheckCircle, AlertCircle, RefreshCw, Music } from 'lucide-react';
import { PRESETS } from '@/lib/ffmpeg'; // PRESETS are still defined here
...
export const ConversionCard: React.FC<ConversionCardProps> = ({
  ...
  // Initialize output filename once when the component mounts or file changes
  useEffect(() => {
    if (!outputFilename && file?.originalName) {
